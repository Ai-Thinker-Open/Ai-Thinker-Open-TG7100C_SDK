...
function files_cp()
{
	...
	cp Living_SDK/platform/mcu/asr5502/drivers/libs/Cortex-M4/mcu_52m/libasr_wifi.a  prebuild/lib/
	cp Living_SDK/platform/mcu/asr5502/drivers/libs/Cortex-M4/libota_port.a prebuild/lib/
	cp Living_SDK/platform/mcu/asr5502/drivers/libs/Cortex-M4/libarm_cortexM4l_math.a  prebuild/lib/
...
function build_bin()
{
	...
	tools/asr5502/image_gen_header $OUT/$2@$3.bin "image_compress"
