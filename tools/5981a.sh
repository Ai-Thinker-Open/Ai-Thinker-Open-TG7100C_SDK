...
function build_bin()
{
	...
	if [[ "$2" == httpapp ]] || [[ "$2" == coapapp ]];then
		COMMON_LIBS="$p/$2.a  $p/board_$3.a  $p/$CHIP.a  $p/vcall.a  $p/kernel_init.a  $p/auto_component.a  $p/libiot_sdk.a  $p/iotx-hal.a   $p/netmgr.a  $p/framework.a  $p/cjson.a  $p/cli.a $p/ota_hal.a $p/$ARCH.a  $p/newlib_stub.a  $p/rhino.a  $p/digest_algorithm.a  $p/net.a  $p/log.a  $p/activation.a  $p/chip_code.a  $p/imbedtls.a  $p/kv.a  $p/yloop.a  $p/hal.a   $p/base64.a  $p/alicrypto.a  $p/vfs.a  $p/vfs_device.a   $p/libawss_security.a $p/libaiotss.a "
	else
