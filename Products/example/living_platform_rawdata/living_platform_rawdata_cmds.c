...
static void timer_func_devap_zconfig_timeout(void *arg1, void *arg2)
{
    ...
    if (awss_get_config_press())
    {
        ...
        living_platform_rawdata_do_awss_dev_ap(NULL);
    }
    else
    {
...
void living_platform_rawdata_do_awss_active(void *arg)
{
...
void living_platform_rawdata_do_awss_dev_ap(void *arg)
{
    aos_task_new("netmgr_stop", stop_netmgr, NULL, 4096);
    aos_task_new("dap_open", awss_open_dev_ap, NULL, 4096);
}

void living_platform_rawdata_do_awss(void *arg)
{
...
void living_platform_rawdata_awss_reset(void *arg)
{
#ifdef WIFI_PROVISION_ENABLED
...
int living_platform_rawdata_register_cmds(void *arg)
{
