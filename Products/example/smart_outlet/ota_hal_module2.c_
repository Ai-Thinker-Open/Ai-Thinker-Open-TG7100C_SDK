...
static int ota_image_check(uint32_t image_size)
{
    ...
    {
        printf("RX:   %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x",
        ...
        printf("Need: %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x",
        ...
        printf("user crc check fail\r\n");
        goto exit;
    }

    printf("OTA image md5 check success");
...
static int ota_boot(void *something)
{
    ...
    HAL_Kv_Set("ota_m_name_2", module_name_value, strlen(module_name_value), 1);
    HAL_Kv_Set("ota_m_version_2",module_version_value, strlen(module_version_value), 1);
    #endif
        ota_reboot();
    }
    return ret;
...
ota_hal_module_t ota_hal_module2 = {
    .init = ota_init,
    .write = ota_write,
    .read = ota_read,
    .boot = ota_boot,
