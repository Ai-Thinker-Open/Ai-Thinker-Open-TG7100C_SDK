...
static struct net_device tg7100c_sta;
...
#if 0
    struct net_device * tg7100c_sta = (struct net_device *)dev;
#endif
    struct pbuf* q;
...
#define WARNING_LIMIT_TICKS_TX_SIZE  2000
    ...
    bl_output(tg7100c_sta.bl_hw, netif, p, 0 == wlan->mode);
    return 0;
}
#endif
...
int tg7100c_wifi_init(wifi_conf_t *conf)
{
    uint8_t mac[6];
    int ret;
    ...
    memset(&tg7100c_sta, 0, sizeof(tg7100c_sta));
    ret = bl_main_rtthread_start(&(tg7100c_sta.bl_hw));
