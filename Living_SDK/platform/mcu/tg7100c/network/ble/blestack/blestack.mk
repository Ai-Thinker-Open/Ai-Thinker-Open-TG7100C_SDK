...
#include platform/mcu/tg7100c/network/ble/ble_common.mk
...
BLESTACK_ADD_INCLUDEDIRS := $(ble_stack_srcs_include_dirs)

## not be exported to project level
BLESTACK_PRIV_INCLUDEDIRS   :=
...
$(NAME)_SOURCES := $(ble_stack_srcs)
GLOBAL_INCLUDES += $(BLESTACK_ADD_INCLUDEDIRS) 
GLOBAL_INCLUDES += $(ble_stack_srcs_dirs)
