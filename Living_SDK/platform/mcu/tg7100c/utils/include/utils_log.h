...
#define __utils_printf              blog_debug
...
#define log_trace2(M, ...)   custom_log("\x1b[94mTRACE \x1b[0m", M, ##__VA_ARGS__);printf("\r\n");
#define log_debug2(M, ...)   custom_log("\x1b[36mDEBUG \x1b[0m", M, ##__VA_ARGS__);printf("\r\n");
#define log_info2(M, ...)    custom_log("\x1b[32mINFO  \x1b[0m", M, ##__VA_ARGS__);printf("\r\n");
#define log_warn2(M, ...)    custom_log("\x1b[33mWARN  \x1b[0m", M, ##__VA_ARGS__);printf("\r\n");
#define log_error2(M, ...)   custom_log("\x1b[31mERROR \x1b[0m", M, ##__VA_ARGS__);printf("\r\n");
#define log_assert2(M, ...)  custom_log("\x1b[35mASSERT\x1b[0m", M, ##__VA_ARGS__);printf("\r\n");
#else
