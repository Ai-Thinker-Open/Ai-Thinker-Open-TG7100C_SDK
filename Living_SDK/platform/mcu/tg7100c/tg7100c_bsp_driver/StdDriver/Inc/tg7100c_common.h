#ifndef __TG7100C_COMMON_H__
#define __TG7100C_COMMON_H__
...
#define ARCH_Delay_MS       TG7100C_Delay_MS
#define ARCH_MemCpy_Fast    TG7100C_MemCpy_Fast
/**
...
void TG7100C_Delay_US(uint32_t cnt);
void TG7100C_Delay_MS(uint32_t cnt);
void *TG7100C_MemCpy(void *dst, const void *src, uint32_t n);
uint32_t *TG7100C_MemCpy4(uint32_t *dst, const uint32_t *src, uint32_t n);
void *TG7100C_MemCpy_Fast(void *pdst, const void *psrc, uint32_t n);
void* TG7100C_MemSet(void *s, uint8_t c, uint32_t n);
uint32_t *TG7100C_MemSet4(uint32_t *dst, const uint32_t val, uint32_t n);
int TG7100C_MemCmp(const void *s1, const void *s2, uint32_t n);


/*@} end of group DRIVER_COMMON  */

#endif /* __TG7100C_COMMON_H__ */
