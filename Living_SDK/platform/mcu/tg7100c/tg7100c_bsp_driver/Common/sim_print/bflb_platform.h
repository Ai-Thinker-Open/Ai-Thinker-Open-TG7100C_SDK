...
extern void TG7100C_Delay_US(uint32_t cnt);
...
#define BL_CASE_FAIL            {SIM_FAIL;while(1){TG7100C_Delay_US(10);};}
#define BL_CASE_SUCCESS         {SIM_END;while(1){TG7100C_Delay_US(10);};}
