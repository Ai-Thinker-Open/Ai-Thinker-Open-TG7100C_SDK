#ifndef __TG7100C_H__
#define __TG7100C_H__
...
#endif
/**
 * @brief TG7100C Interrupt Number Definition, according to the selected device
...
#endif
/******  TG7100C specific Interrupt Numbers **********************************************************************/
...
/**
 * @brief TG7100C Memory Map Definitions
 */
#define TG7100C_FLASH_XIP_BASE        		0x23000000
#define TG7100C_FLASH_XIP_END					(0x23000000+16*1024*1024)
#define TG7100C_FLASH_XIP_REMAP0_BASE			0x33000000
#define TG7100C_FLASH_XIP_REMAP0_END			(0x33000000+16*1024*1024)
#define TG7100C_FLASH_XIP_REMAP1_BASE			0x43000000
#define TG7100C_FLASH_XIP_REMAP1_END			(0x43000000+16*1024*1024)
#define TG7100C_FLASH_XIP_REMAP2_BASE			0x53000000
#define TG7100C_FLASH_XIP_REMAP2_END			(0x53000000+16*1024*1024)

#define TG7100C_WRAM_BASE             		0x42020000
#define TG7100C_WRAM_END              		(0x42020000+176*1024)
#define TG7100C_WRAM_REMAP0_BASE             	0x22020000
#define TG7100C_WRAM_REMAP0_END              	(0x22020000+176*1024)
#define TG7100C_WRAM_REMAP1_BASE             	0x32020000
#define TG7100C_WRAM_REMAP1_END              	(0x32020000+176*1024)
#define TG7100C_WRAM_REMAP2_BASE             	0x52020000
#define TG7100C_WRAM_REMAP2_END              	(0x52020000+176*1024)

#define TG7100C_TCM_BASE              		0x22008000
#define TG7100C_TCM_END               		(0x22008000+(96+176)*1024)
#define TG7100C_TCM_REMAP0_BASE              	0x32008000
#define TG7100C_TCM_REMAP0_END               	(0x32008000+(96+176)*1024)
#define TG7100C_TCM_REMAP1_BASE             	0x42008000
#define TG7100C_TCM_REMAP1_END             	(0x42008000+(96+176)*1024)
#define TG7100C_TCM_REMAP2_BASE             	0x52008000
#define TG7100C_TCM_REMAP2_END              	(0x52008000+(96+176)*1024)
/*@} end of group Memory_Map_Section */

/* TG7100C peripherals base address */
