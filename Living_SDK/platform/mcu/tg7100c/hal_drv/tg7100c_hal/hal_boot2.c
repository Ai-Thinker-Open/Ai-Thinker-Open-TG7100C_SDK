...
void hal_update_mfg_ptable(void)
{
    ...
    printf("====================\r\n");
    if (0 == hal_boot2_get_active_entries_byname(PT_OTA_TYPE_NAME, &ptEntry_fw)) {       // ota
        if (0 == hal_boot2_get_active_entries_byname(PT_MEDIA_TYPE_NAME, &ptEntry_media)) { // media
