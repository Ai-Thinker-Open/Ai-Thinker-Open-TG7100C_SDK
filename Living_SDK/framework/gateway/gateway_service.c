...
{
#ifdef CONFIG_YWSS
    struct registrar_enr_record_s *mesh_enrollee;
    ...
    mesh_enrollee = (struct registrar_enr_record_s *)os_malloc(sizeof(struct registrar_enr_record_s));
    OS_CHECK_MALLOC(mesh_enrollee);

    memset(mesh_enrollee, 0, sizeof(struct registrar_enr_record_s));
    ...
    awss_registrar_enr_inqueue(mesh_enrollee);
