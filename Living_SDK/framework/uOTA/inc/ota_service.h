...
#define OTA_MODULE_NAME_LEN_MAX (64)
...
typedef struct{
    ...
    char module_version[MODULE_VERSION_LEN + 1];
    char product_key[PRODUCT_KEY_LEN + 1];
    char device_name[DEVICE_NAME_LEN + 1];
    ota_hal_module_t *hal;
    slist_t next;
}iotx_ota_module_info_t, *iotx_ota_module_info_pt;
...
typedef struct {
    ...
    char upg_module_flag; /*need to upgrade a module*/
    iotx_ota_module_info_t *module_info;
    iotx_ota_module_info_t *module_report;
    slist_t module_list;
} ota_service_t;
